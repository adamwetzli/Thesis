from utils import load_and_split, plot_nested_correlation_heatmap, BlockingTimeSeriesSplit
from forex_feature_preprocessing import preprocess_features, run_feature_selection_pipeline
import os

def test_nested_corr_heatmap(n_outer_splits):
    ...
    if Xs_folds:
        plot_nested_correlation_heatmap(Xs_folds=Xs_folds, title_pre='Test')

if __name__ == "__main__":
    test_nested_corr_heatmap(2)