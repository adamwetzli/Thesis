...
\begin{enumerate}
  ...
  \begin{enumerate}
    \item \textit{Question:} Can the Deflated Sharpe Ratio (DSR) and positive False Discovery Rate (pFDR) prevent the deployment of over-optimized models?
...
where \(\Phi\) is the CDF of the standard normal distribution and \(SR^*\) is the benchmark. 
To correct for the data mining trap, \textcite{bailey_deflated_2014} introduced the deflated Sharpe ratio (DSR), 
...
\subsubsection{Evaluation on OOS Test Data}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\linewidth]{data/figures/optimization/distributions/tournament_financial_dists_RandomForest.png}
    \caption{Financial Statistic Distributions during Optimization}
...
\begin{figure}[H]
    ...
    \begin{minipage}[t]{0.45\textwidth}
        ...
        \caption{Model-Specific Conformal Filtering}
    ...
    \begin{minipage}[t]{0.45\textwidth}
        ...
        \caption{Model-Specific Conformal Filtering (continued)}
...
\begin{figure}[H]
    ...
    \begin{minipage}[t]{0.45\textwidth}
        ...
        \caption{Model-Specific Confusion Matrices}
    ...
    \begin{minipage}[t]{0.45\textwidth}
        ...
        \caption{Model-Specific Confusion Matrices (continued)}
...
\begin{figure}[H]
    ...
    \begin{minipage}[t]{0.45\textwidth}
        ...
        \caption{Model-Specific Reliability Diagrams}
...
\subsubsection{Refactoring of the Code Base}
Strengthen to make deployment and debugging better
...
\subsection{Model-Specific Backtest Results}
\begin{figure}[H]
    \centering
    \begin{minipage}[t]{0.45\textwidth}
        \centering
...
\section{Production Model}\label{app:second}
...
\begin{figure}[H]
    ...
    \caption{Production Correlation Filtering}
...
\begin{figure}[H]
    ...
    \caption{Production Feature Importance Filtering}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\linewidth]{data/figures/optimization/distributions/production_financial_dists_RandomForest.png}
    \caption{Production Statistic Distributions}
    \label{fig:prod stat distributions}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\linewidth]{data/figures/optimization/production/RandomForest/opt_history_model_randomforest.png}
    \caption{Optimization History RandomForest}
    \label{fig:opt hist rf}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\linewidth]{data/figures/optimization/production/RandomForest/opt_history_trading_(best)_randomforest.png}
    \caption{Optimization History Trading (Best) RandomForest}
    \label{fig:opt hist trading rf}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\linewidth]{data/figures/optimization/production/RandomForest/parallel_coordinate_model_randomforest.png}
    \caption{Optimization Parallel Coordinate Model RandomForest}
    \label{fig:opt parallel coordinate model rf}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\linewidth]{data/figures/optimization/production/RandomForest/parallel_coordinate_trading_(best)_randomforest.png}
    \caption{Optimization Parallel Coordinate Model Trading (Best) RandomForest}
    \label{fig:opt parallel coordinate model trading rf}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\linewidth]{data/figures/conformal_predictions/Production_conformal_predictions.png}
    \caption{Conformal Predictions Production}
...
\begin{figure}[H]
    ...
    \caption{Confusion Matrices Production}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\linewidth]{data/figures/reliability_diagrams/Production_reliability_diagrams.png}
    \caption{Reliability Curves Production}
